...
A plugin which will endeavor to guess your terminal's level of color
support.

> [colors](/rjs-plugins/colors) plugin uses this plugin.
...
```javascript
var testColorSupport = require('rovel.js').supportsColors
...
```javascript
var colorSupport = require('rovel.js').supportsColor
...
You can run the `supports-colors` bin from the command line (if you had installed **rovel.js** globally) which will
